...
%     end
    ...
    figure;
    errorbar(log2(downscale_list),reflection_list,1.96*reflection_stderr_list,'b--','LineWidth',2); hold on;
    plot(log2(downscale_list),reflection_list,'b--','LineWidth',2);

    errorbar(log2(downscale_list_n),reflection_list_n,1.96*reflection_stderr_list_n,'r','LineWidth',2); hold on;
    plot(log2(downscale_list_n),reflection_list_n,'r','LineWidth',2);
